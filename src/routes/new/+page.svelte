<script lang="ts">
	...
	import MainPollSettings from '$lib/components/pollbuilder/MainPollSettings.svelte';
	import PollSectionSettings from '$lib/components/pollbuilder/PollSectionSettings.svelte';
